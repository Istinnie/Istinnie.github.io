...
function hideHamburger() {
  document.querySelector(".toggle-btn span:nth-child(1)").style.transform =
    "rotate(45deg) translateY(10px) translateX(10px)";
  document.querySelector(".toggle-btn span:nth-child(2)").style.display =
    "none";
  document.querySelector(".toggle-btn span:nth-child(3)").style.transform =
    "rotate(-45deg)";
}
